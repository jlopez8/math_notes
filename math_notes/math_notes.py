...
def math_canvas(filename={'filename': ''}, width=1200, height=400, linewidth=3, linecolor='BLACK'):
    ...
    button_explore = Button(
        root, text='Browse Files', command=lambda: be.browse_files(filename)
    )
